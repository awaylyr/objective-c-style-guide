# The official cncn Objective-C style guide.

This style guide outlines the coding conventions for cncn inherited from raywenderlich.com.
...
* Method braces should always close on a new line but not open on the same line. 
